...
include_once $this->targetDirs[3].'/src/Loader/RouterLoader.php';
...
$a = ($this->privates['file_locator'] ?? $this->privates['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator(($this->services['kernel'] ?? $this->get('kernel', 1)), ($this->targetDirs[3].'/src/Resources'), array(0 => ($this->targetDirs[3].'/src'))));
...
$d->addLoader(new \App\Loader\RouterLoader(($this->services['kernel'] ?? $this->get('kernel', 1))));

...
$d->addEventSubscriber(new \App\Listener\ORM\DoctrineListener());
$d->addEventListener(array(0 => 'postGenerateSchema'), new \App\Extensions\Doctrine\SchemaViewIgnorer());
$d->addEventListener(array(0 => 'loadClassMetadata'), new \App\Extensions\Doctrine\TablePrefix(''));
$d->addEventListener(array(0 => 'loadClassMetadata'), new \Doctrine\ORM\Tools\AttachEntityListenersListener());

return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array()))->createConnection(array('url' => $this->getEnv('resolve:DATABASE_URL'), 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driver' => 'pdo_mysql', 'driverOptions' => array(), 'defaultTableOptions' => array()), $c, $d, array());

...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'App\\Controller\\Admin\\ApiController' => 'getApiControllerService.php',
            'App\\Controller\\Admin\\DepartamentoController' => 'getDepartamentoControllerService.php',
            'App\\Controller\\Admin\\LocaisController' => 'getLocaisControllerService.php',
            'App\\Controller\\Admin\\ModulosController' => 'getModulosControllerService.php',
            'App\\Controller\\Admin\\PerfisController' => 'getPerfisControllerService.php',
            'App\\Controller\\Admin\\PrioridadesController' => 'getPrioridadesControllerService.php',
            'App\\Controller\\Admin\\ServicosController' => 'getServicosControllerService.php',
            'App\\Controller\\Admin\\UnidadesController' => 'getUnidadesControllerService.php',
            'App\\Controller\\Api\\AgendamentosController' => 'getAgendamentosControllerService.php',
            'App\\Controller\\Api\\AtendimentosController' => 'getAtendimentosControllerService.php',
            'App\\Controller\\Api\\AtendimentosHistoricoController' => 'getAtendimentosHistoricoControllerService.php',
            'App\\Controller\\Api\\DefaultController' => 'getDefaultControllerService.php',
            'App\\Controller\\Api\\DepartamentosController' => 'getDepartamentosControllerService.php',
            'App\\Controller\\Api\\FilasController' => 'getFilasControllerService.php',
            'App\\Controller\\Api\\LocaisController' => 'getLocaisController2Service.php',
            'App\\Controller\\Api\\PainelController' => 'getPainelControllerService.php',
            'App\\Controller\\Api\\PrioridadesController' => 'getPrioridadesController2Service.php',
            'App\\Controller\\Api\\ServicosController' => 'getServicosController2Service.php',
            'App\\Controller\\Api\\TriagemController' => 'getTriagemControllerService.php',
            'App\\Controller\\Api\\UnidadesController' => 'getUnidadesController2Service.php',
            'App\\Controller\\Api\\UsuariosController' => 'getUsuariosControllerService.php',
            'App\\Controller\\DefaultController' => 'getDefaultController2Service.php',
            ...
            'App\\Service\\TicketService' => 'getTicketServiceService.php',
            'Novosga\\AttendanceBundle\\Controller\\DefaultController' => 'getDefaultController3Service.php',
            'Novosga\\MonitorBundle\\Controller\\DefaultController' => 'getDefaultController4Service.php',
            'Novosga\\ReportsBundle\\Controller\\DefaultController' => 'getDefaultController5Service.php',
            'Novosga\\Service\\AtendimentoService' => 'getAtendimentoServiceService.php',
            'Novosga\\Service\\FilaService' => 'getFilaServiceService.php',
            'Novosga\\Service\\ServicoService' => 'getServicoServiceService.php',
            'Novosga\\Service\\UnidadeService' => 'getUnidadeServiceService.php',
            'Novosga\\Service\\UsuarioService' => 'getUsuarioServiceService.php',
            'Novosga\\SettingsBundle\\Controller\\DefaultController' => 'getDefaultController6Service.php',
            'Novosga\\TriageBundle\\Controller\\DefaultController' => 'getDefaultController7Service.php',
            'Novosga\\UsersBundle\\Controller\\DefaultController' => 'getDefaultController8Service.php',
            ...
            'console.command.public_alias.App\\Command\\CheckCommand' => 'getCheckCommandService.php',
            ...
            'console.command.public_alias.App\\Command\\UnidadesCommand' => 'getUnidadesCommandService.php',
            'console.command.public_alias.App\\Command\\UpdateCommand' => 'getUpdateCommandService.php',
            'console.command.public_alias.App\\Command\\WebsocketCommand' => 'getWebsocketCommandService.php',
        ...
        $this->privates['service_container'] = function () {
            include_once $this->targetDirs[3].'/src/Listener/AppListener.php';
            include_once $this->targetDirs[3].'/src/Listener/AccessListener.php';
            include_once $this->targetDirs[3].'/src/Listener/CorsListener.php';
            include_once $this->targetDirs[3].'/src/Listener/SessionListener.php';
            ...
            include_once $this->targetDirs[3].'/modules/novosga/reports-bundle/Twig/ReportExtension.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Jo77W9UVDS', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6rw5zt+bK0', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', array(0 => function () {
            return ($this->privates['App\Listener\AccessListener'] ?? $this->getAccessListenerService());
        }, 1 => 'onKernelRequest'), 7);
        $instance->addListener('kernel.request', array(0 => function () {
            return ($this->privates['App\Listener\CorsListener'] ?? $this->getCorsListenerService());
        }, 1 => 'onKernelRequest'), 700);
        $instance->addListener('kernel.exception', array(0 => function () {
            return ($this->privates['App\Listener\JsonExceptionListener'] ?? $this->load('getJsonExceptionListenerService.php'));
        }, 1 => 'onKernelException'), 1000);
        $instance->addListener('kernel.request', array(0 => function () {
            return ($this->privates['App\Listener\SessionListener'] ?? $this->getSessionListenerService());
        }, 1 => 'onKernelRequest'), 6);
        $instance->addListener('security.interactive_login', array(0 => function () {
            return ($this->privates['App\Security\SecurityListener'] ?? $this->load('getSecurityListenerService.php'));
        ...
        $instance->addListener('kernel.request', array(0 => function () {
            return ($this->privates['session_listener'] ?? $this->getSessionListener2Service());
    ...
    protected function getTranslatorService()
    {
        ...
        })), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\MessageSelector()), $this->getEnv('LANGUAGE'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yaml', 1 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => ($this->targetDirs[0].'/translations'), 'debug' => true, 'resource_files' => array('af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.af.xlf')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.ar.xlf')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.az.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.bg.xlf')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.ca.xlf')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.cs.xlf')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.cy.xlf')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.da.xlf')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/vendor/novosga/oauth-server-bundle/Resources/translations/FOSOAuthServerBundle.de.yml')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.el.xlf')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/vendor/novosga/oauth-server-bundle/Resources/translations/FOSOAuthServerBundle.en.yml'), 4 => ($this->targetDirs[3].'/modules/novosga/settings-bundle/Resources/translations/NovosgaSettingsBundle.en.xlf'), 5 => ($this->targetDirs[3].'/modules/novosga/triage-bundle/Resources/translations/NovosgaTriageBundle.en.xlf'), 6 => ($this->targetDirs[3].'/modules/novosga/monitor-bundle/Resources/translations/NovosgaMonitorBundle.en.xlf'), 7 => ($this->targetDirs[3].'/modules/novosga/reports-bundle/Resources/translations/NovosgaReportsBundle.en.xlf'), 8 => ($this->targetDirs[3].'/modules/novosga/users-bundle/Resources/translations/NovosgaUsersBundle.en.xlf'), 9 => ($this->targetDirs[3].'/modules/novosga/attendance-bundle/Resources/translations/NovosgaAttendanceBundle.en.xlf'), 10 => ($this->targetDirs[3].'/translations/messages.en.xlf'), 11 => ($this->targetDirs[3].'/translations/messages.en.xlf')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/modules/novosga/settings-bundle/Resources/translations/NovosgaSettingsBundle.es.xlf'), 4 => ($this->targetDirs[3].'/modules/novosga/triage-bundle/Resources/translations/NovosgaTriageBundle.es.xlf'), 5 => ($this->targetDirs[3].'/modules/novosga/monitor-bundle/Resources/translations/NovosgaMonitorBundle.es.xlf'), 6 => ($this->targetDirs[3].'/modules/novosga/reports-bundle/Resources/translations/NovosgaReportsBundle.es.xlf'), 7 => ($this->targetDirs[3].'/modules/novosga/users-bundle/Resources/translations/NovosgaUsersBundle.es.xlf'), 8 => ($this->targetDirs[3].'/modules/novosga/attendance-bundle/Resources/translations/NovosgaAttendanceBundle.es.xlf'), 9 => ($this->targetDirs[3].'/translations/messages.es.xlf'), 10 => ($this->targetDirs[3].'/translations/messages.es.xlf')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.et.xlf')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.eu.xlf')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.fa.xlf')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.fi.xlf')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/vendor/novosga/oauth-server-bundle/Resources/translations/FOSOAuthServerBundle.fr.yml')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.gl.xlf')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.he.xlf')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.hr.xlf')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.hu.xlf')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.hy.xlf')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.id.xlf')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.it.xlf')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.ja.xlf')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.lb.xlf')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.lt.xlf')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.lv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.lv.xlf')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.mn.xlf')), 'nb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.nb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.nb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.nb.xlf')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.nl.xlf')), 'nn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.nn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.nn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.nn.xlf')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.no.xlf')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.pl.xlf')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.pt.xlf')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'/modules/novosga/settings-bundle/Resources/translations/NovosgaSettingsBundle.pt_BR.xlf'), 4 => ($this->targetDirs[3].'/modules/novosga/triage-bundle/Resources/translations/NovosgaTriageBundle.pt_BR.xlf'), 5 => ($this->targetDirs[3].'/modules/novosga/monitor-bundle/Resources/translations/NovosgaMonitorBundle.pt_BR.xlf'), 6 => ($this->targetDirs[3].'/modules/novosga/reports-bundle/Resources/translations/NovosgaReportsBundle.pt_BR.xlf'), 7 => ($this->targetDirs[3].'/modules/novosga/users-bundle/Resources/translations/NovosgaUsersBundle.pt_BR.xlf'), 8 => ($this->targetDirs[3].'/modules/novosga/attendance-bundle/Resources/translations/NovosgaAttendanceBundle.pt_BR.xlf'), 9 => ($this->targetDirs[3].'/translations/messages.pt_BR.xlf'), 10 => ($this->targetDirs[3].'/translations/messages.pt_BR.xlf')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.ro.xlf')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.ru.xlf')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.sk.xlf')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.sl.xlf'), 3 => ($this->targetDirs[3].'/vendor/novosga/oauth-server-bundle/Resources/translations/FOSOAuthServerBundle.sl.yml')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sq.xlf')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.sr_Cyrl.xlf')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.sr_Latn.xlf')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.sv.xlf')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.th.xlf')), 'tl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.tl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.tl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.tl.xlf')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.tr.xlf')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.uk.xlf')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.vi.xlf')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.zh_CN.xlf')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/validator/Resources/translations/validators.zh_TW.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.pt_PT.xlf'), 1 => ($this->targetDirs[3].'/modules/novosga/monitor-bundle/Resources/translations/NovosgaMonitorBundle.pt_PT.xlf'), 2 => ($this->targetDirs[3].'/modules/novosga/attendance-bundle/Resources/translations/NovosgaAttendanceBundle.pt_PT.xlf'), 3 => ($this->targetDirs[3].'/translations/messages.pt_PT.xlf'), 4 => ($this->targetDirs[3].'/translations/messages.pt_PT.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/security/Core/Resources/translations/security.ua.xlf')), 'en_US' => array(0 => ($this->targetDirs[3].'/modules/novosga/settings-bundle/Resources/translations/NovosgaSettingsBundle.en_US.xlf'), 1 => ($this->targetDirs[3].'/translations/messages.en_US.xlf'), 2 => ($this->targetDirs[3].'/translations/messages.en_US.xlf')), 'es_AR' => array(0 => ($this->targetDirs[3].'/modules/novosga/settings-bundle/Resources/translations/NovosgaSettingsBundle.es_AR.xlf'), 1 => ($this->targetDirs[3].'/modules/novosga/monitor-bundle/Resources/translations/NovosgaMonitorBundle.es_AR.xlf'), 2 => ($this->targetDirs[3].'/modules/novosga/reports-bundle/Resources/translations/NovosgaReportsBundle.es_AR.xlf'), 3 => ($this->targetDirs[3].'/modules/novosga/users-bundle/Resources/translations/NovosgaUsersBundle.es_AR.xlf'), 4 => ($this->targetDirs[3].'/modules/novosga/attendance-bundle/Resources/translations/NovosgaAttendanceBundle.es_AR.xlf'), 5 => ($this->targetDirs[3].'/translations/messages.es_AR.xlf'), 6 => ($this->targetDirs[3].'/translations/messages.es_AR.xlf')))));
        $a->setConfigCacheFactory(($this->privates['config_cache_factory'] ?? $this->getConfigCacheFactoryService()));
        $a->setFallbackLocales(array(0 => 'pt_BR'));
    ...
    protected function getTwigService()
    {
        ...
        $a->addPath(($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/views'), '!Swiftmailer');
        $a->addPath(($this->targetDirs[3].'/vendor/novosga/oauth-server-bundle/Resources/views'), 'FOSOAuthServer');
        $a->addPath(($this->targetDirs[3].'/vendor/novosga/oauth-server-bundle/Resources/views'), '!FOSOAuthServer');
        $a->addPath(($this->targetDirs[3].'/modules/novosga/settings-bundle/Resources/views'), 'NovosgaSettings');
        $a->addPath(($this->targetDirs[3].'/modules/novosga/settings-bundle/Resources/views'), '!NovosgaSettings');
        $a->addPath(($this->targetDirs[3].'/modules/novosga/triage-bundle/Resources/views'), 'NovosgaTriage');
        $a->addPath(($this->targetDirs[3].'/modules/novosga/triage-bundle/Resources/views'), '!NovosgaTriage');
        $a->addPath(($this->targetDirs[3].'/modules/novosga/monitor-bundle/Resources/views'), 'NovosgaMonitor');
        $a->addPath(($this->targetDirs[3].'/modules/novosga/monitor-bundle/Resources/views'), '!NovosgaMonitor');
        $a->addPath(($this->targetDirs[3].'/modules/novosga/reports-bundle/Resources/views'), 'NovosgaReports');
        $a->addPath(($this->targetDirs[3].'/modules/novosga/reports-bundle/Resources/views'), '!NovosgaReports');
        $a->addPath(($this->targetDirs[3].'/modules/novosga/users-bundle/Resources/views'), 'NovosgaUsers');
        $a->addPath(($this->targetDirs[3].'/modules/novosga/users-bundle/Resources/views'), '!NovosgaUsers');
        $a->addPath(($this->targetDirs[3].'/modules/novosga/attendance-bundle/Resources/views'), 'NovosgaAttendance');
        $a->addPath(($this->targetDirs[3].'/modules/novosga/attendance-bundle/Resources/views'), '!NovosgaAttendance');
        $a->addPath(($this->targetDirs[3].'/templates'));
        ...
        $instance->addExtension(new \Novosga\ReportsBundle\Twig\ReportExtension());
        ...
        $instance->addGlobal('locale', $this->getEnv('LANGUAGE'));
        $instance->addGlobal('version', '2.1.0');
        $instance->addGlobal('title', 'Novo SGA CE');
    ...
    /**
     * Gets the private 'App\Listener\AccessListener' shared autowired service.
     *
     * @return \App\Listener\AccessListener
     */
    protected function getAccessListenerService()
    {
        return $this->privates['App\Listener\AccessListener'] = new \App\Listener\AccessListener(($this->services['security.authorization_checker'] ?? $this->getSecurity_AuthorizationCheckerService()));
    }

    /**
     * Gets the private 'App\Listener\CorsListener' shared autowired service.
     *
     * @return \App\Listener\CorsListener
     */
    protected function getCorsListenerService()
    {
        return $this->privates['App\Listener\CorsListener'] = new \App\Listener\CorsListener(($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()));
    }

    /**
     * Gets the private 'App\Listener\SessionListener' shared autowired service.
     *
     * @return \App\Listener\SessionListener
     */
    protected function getSessionListenerService()
    {
        return $this->privates['App\Listener\SessionListener'] = new \App\Listener\SessionListener(($this->services['security.token_storage'] ?? $this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), ($this->services['translator'] ?? $this->getTranslatorService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('w9PjYhEPVF', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CTw0BkgxCK', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UXrcViPTTn', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tPvt8cYK0Z', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener(($this->services['request_stack'] ?? $this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack()), $this->getEnv('LANGUAGE'), ($this->services['router'] ?? $this->getRouterService()));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.authentication.provider.fos_oauth_server.api'] ?? $this->load('getSecurity_Authentication_Provider_FosOauthServer_ApiService.php'));
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.api' => function () {
            ...
            yield 'security.firewall.map.context.oauth_token' => ($this->privates['.security.request_matcher...PBbkH'] ?? $this->privates['.security.request_matcher...PBbkH'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/token'));
            yield 'security.firewall.map.context.api' => ($this->privates['.security.request_matcher.mXRZlgt'] ?? $this->privates['.security.request_matcher.mXRZlgt'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(api|\\w+\\.\\w+/api)'));
     ...
     */
    protected function getSessionListener2Service()
    {
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => ($this->targetDirs[3].'/vendor/symfony/form/Resources/config/validation.xml'), 1 => ($this->targetDirs[3].'/vendor/novosga/oauth-server-bundle/Resources/config/validation.xml')));
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/config/validation/Local.yml'), 1 => ($this->targetDirs[3].'/config/validation/Lotacao.yml'), 2 => ($this->targetDirs[3].'/config/validation/Perfil.yml'), 3 => ($this->targetDirs[3].'/config/validation/Servico.yml'), 4 => ($this->targetDirs[3].'/config/validation/Unidade.yml'), 5 => ($this->targetDirs[3].'/config/validation/Usuario.yml')));
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'FOSOAuthServerBundle' => array(
                    'path' => ($this->targetDirs[3].'/vendor/novosga/oauth-server-bundle'),
                    'namespace' => 'FOS\\OAuthServerBundle',
                ),
                'NovosgaSettingsBundle' => array(
                    'path' => ($this->targetDirs[3].'/modules/novosga/settings-bundle'),
                    'namespace' => 'Novosga\\SettingsBundle',
                ),
                'NovosgaTriageBundle' => array(
                    'path' => ($this->targetDirs[3].'/modules/novosga/triage-bundle'),
                    'namespace' => 'Novosga\\TriageBundle',
                ),
                'NovosgaMonitorBundle' => array(
                    'path' => ($this->targetDirs[3].'/modules/novosga/monitor-bundle'),
                    'namespace' => 'Novosga\\MonitorBundle',
                ),
                'NovosgaReportsBundle' => array(
                    'path' => ($this->targetDirs[3].'/modules/novosga/reports-bundle'),
                    'namespace' => 'Novosga\\ReportsBundle',
                ),
                'NovosgaUsersBundle' => array(
                    'path' => ($this->targetDirs[3].'/modules/novosga/users-bundle'),
                    'namespace' => 'Novosga\\UsersBundle',
                ),
                'NovosgaAttendanceBundle' => array(
                    'path' => ($this->targetDirs[3].'/modules/novosga/attendance-bundle'),
                    'namespace' => 'Novosga\\AttendanceBundle',
                ),
            ); break;
            case 'locale': $value = $this->getEnv('LANGUAGE'); break;
            case 'kernel.secret': $value = $this->getEnv('APP_SECRET'); break;
            case 'kernel.default_locale': $value = $this->getEnv('LANGUAGE'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'NovosgaSettingsBundle' => 'Novosga\\SettingsBundle\\NovosgaSettingsBundle',
                'NovosgaTriageBundle' => 'Novosga\\TriageBundle\\NovosgaTriageBundle',
                'NovosgaMonitorBundle' => 'Novosga\\MonitorBundle\\NovosgaMonitorBundle',
                'NovosgaReportsBundle' => 'Novosga\\ReportsBundle\\NovosgaReportsBundle',
                'NovosgaUsersBundle' => 'Novosga\\UsersBundle\\NovosgaUsersBundle',
                'NovosgaAttendanceBundle' => 'Novosga\\AttendanceBundle\\NovosgaAttendanceBundle',
            ),
            ...
            'fos_oauth_server.model.client.class' => 'App\\Entity\\OAuthClient',
            'fos_oauth_server.model.access_token.class' => 'App\\Entity\\OAuthAccessToken',
            'fos_oauth_server.model.refresh_token.class' => 'App\\Entity\\OAuthRefreshToken',
            'fos_oauth_server.model.auth_code.class' => 'App\\Entity\\OAuthAuthCode',
            ...
            'console.command.ids' => array(
                0 => 'console.command.public_alias.App\\Command\\CheckCommand',
                1 => 'console.command.public_alias.App\\Command\\InstallCommand',
                2 => 'console.command.public_alias.App\\Command\\ResetCommand',
                3 => 'console.command.public_alias.App\\Command\\UnidadesCommand',
                4 => 'console.command.public_alias.App\\Command\\UpdateCommand',
                5 => 'console.command.public_alias.App\\Command\\WebsocketCommand',
                ...
                11 => 'console.command.public_alias.doctrine_migrations.execute_command',
                12 => 'console.command.public_alias.doctrine_migrations.generate_command',
                13 => 'console.command.public_alias.doctrine_migrations.latest_command',
                14 => 'console.command.public_alias.doctrine_migrations.migrate_command',
                15 => 'console.command.public_alias.doctrine_migrations.status_command',
                16 => 'console.command.public_alias.doctrine_migrations.version_command',
            ),
        );
    }
}

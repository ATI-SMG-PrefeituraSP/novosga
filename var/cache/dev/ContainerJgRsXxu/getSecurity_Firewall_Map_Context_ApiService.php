...
include_once $this->targetDirs[3].'/vendor/novosga/oauth-server-bundle/Security/EntryPoint/OAuthEntryPoint.php';
...
}, 3), new \Symfony\Component\Security\Http\Firewall\ExceptionListener(($this->services['security.token_storage'] ?? $this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), ($this->privates['security.authentication.trust_resolver'] ?? $this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver('Symfony\\Component\\Security\\Core\\Authentication\\Token\\AnonymousToken', 'Symfony\\Component\\Security\\Core\\Authentication\\Token\\RememberMeToken')), ($this->privates['security.http_utils'] ?? $this->load('getSecurity_HttpUtilsService.php')), 'api', new \FOS\OAuthServerBundle\Security\EntryPoint\OAuthEntryPoint(($this->services['fos_oauth_server.server'] ?? $this->load('getFosOauthServer_ServerService.php'))), NULL, NULL, ($this->privates['monolog.logger.security'] ?? $this->load('getMonolog_Logger_SecurityService.php')), true), NULL, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('api', 'security.user_checker', '.security.request_matcher.mXRZlgt', true, true, 'App\\Security\\UserProvider', NULL, 'fos_oauth_server.security.entry_point', NULL, NULL, array(0 => 'fos_oauth'), NULL));

...
$a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/config/doctrine/orm/api') => 'App\\Entity', ($this->targetDirs[3].'/config/doctrine/orm/core') => 'Novosga\\Entity'));
$a->setGlobalBasename('mapping');

$b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/vendor/novosga/oauth-server-bundle/Resources/config/doctrine') => 'FOS\\OAuthServerBundle\\Entity'));
$b->setGlobalBasename('mapping');

$c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$c->addDriver($a, 'App\\Entity');
$c->addDriver($a, 'Novosga\\Entity');
$c->addDriver($b, 'FOS\\OAuthServerBundle\\Entity');

$d = new \Doctrine\ORM\Configuration();
$d->setEntityNamespaces(array('App' => 'App\\Entity', 'Novosga' => 'Novosga\\Entity', 'FOSOAuthServerBundle' => 'FOS\\OAuthServerBundle\\Entity'));
...
$d->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ORM\\UsuarioRepository' => function () {
